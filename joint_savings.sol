...
contract JointSavings {
    ...
    function deposit() public payable {
        ...
        the contract by using `address(this).balance`.*/
        contractBalance = address(this).balance;
    }
    ...
    /*Adding the **default fallback function** so that contract can store Ether sent from outside the deposit function.*/
